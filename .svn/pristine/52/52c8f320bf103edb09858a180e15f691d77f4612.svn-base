...
- (void)setStatus:(NSString *)string {
    ...
    CGSize titleSize = CGSizeMake(hudWidth, 20000.0f);
    NSDictionary * tdic = [NSDictionary dictionaryWithObjectsAndKeys:self.stringLabel.font, NSFontAttributeName,nil];
    titleSize =[self.stringLabel.text boundingRectWithSize:titleSize options:NSStringDrawingUsesLineFragmentOrigin |NSStringDrawingUsesFontLeading attributes:tdic context:nil].size;
    
    CGFloat stringWidth = titleSize.width+28;
