...
- (UILabel *)overlayLabelWithText:(NSString *)text
    ...
    NSDictionary * tdic = [NSDictionary dictionaryWithObjectsAndKeys:overlayLabel.font, NSFontAttributeName,nil];
    CGSize titleSize =[overlayLabel.text boundingRectWithSize:maximumLabelSize options:NSStringDrawingUsesLineFragmentOrigin |NSStringDrawingUsesFontLeading attributes:tdic context:nil].size;
