...
#define registerBtn_size_height   40
...
- (id)initWithFrame:(CGRect)frame {
    ...
    UIImageView *lineView = [[UIImageView alloc]initWithFrame:CGRectMake(0, _phoneField.view.frame.size.height, _phoneField.view.frame.size.width, 1)];
    ...
    lineView = [[UIImageView alloc]initWithFrame:CGRectMake(0, _passwordField.view.frame.origin.y+_passwordField.frame.size.height, _phoneField.view.frame.size.width, 1)];
    [lineView setBackgroundColor:[UIColor colorWithRed:163.0/255.0 green:198.0/255.0 blue:191.0/255.0 alpha:1]];
    [self addSubview:lineView];
    ...
    lineView = [[UIImageView alloc]initWithFrame:CGRectMake(0, _repasswordField.view.frame.origin.y+_repasswordField.frame.size.height, _repasswordField.view.frame.size.width, 1)];
    [lineView setBackgroundColor:[UIColor colorWithRed:163.0/255.0 green:198.0/255.0 blue:191.0/255.0 alpha:1]];
    [self addSubview:lineView];
    
    
    CGRect validaBtnRect = CGRectMake(0, repassRect.origin.y+textField_size_height+10, frame.size.width/2, textField_size_height-10);
    _getValidaBtn = [[UILabel alloc]initWithFrame:validaBtnRect];
    ...
    CGRect validaRect = CGRectMake(frame.size.width/2, repassRect.origin.y+textField_size_height+10, frame.size.width/2, textField_size_height-10);
    ...
    lineView = [[UIImageView alloc]initWithFrame:CGRectMake(frame.size.width/2, _validaField.view.frame.origin.y+_validaField.frame.size.height-1, frame.size.width/2, 1)];
    [lineView setBackgroundColor:[UIColor colorWithRed:163.0/255.0 green:198.0/255.0 blue:191.0/255.0 alpha:1]];
    [self addSubview:lineView];
...
//    [self addSubview:_protocolLabel];
    ...
    _registerBtn = [QBFlatButton buttonWithType:UIButtonTypeCustom];
    _registerBtn.frame = CGRectMake(0, self.frame.size.height -registerBtn_size_height-20 , self.frame.size.width, registerBtn_size_height);
    _registerBtn.faceColor = [UIColor colorWithRed:86.0/255.0 green:161.0/255.0 blue:217.0/255.0 alpha:1.0];
    _registerBtn.sideColor = [UIColor colorWithRed:79.0/255.0 green:127.0/255.0 blue:179.0/255.0 alpha:1.0];
    _registerBtn.radius = 8.0;
    _registerBtn.margin = 3.0;
    _registerBtn.depth = 3.0;
